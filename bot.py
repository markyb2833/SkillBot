...
# Load cogs
async def load_cogs():
    cogs = ['cogs.games', 'cogs.group_finder', 'cogs.integrations', 'cogs.economy', 'cogs.admin', 'cogs.quotes', 'cogs.welcome', 'cogs.bump_reminder', 'cogs.audit_log', 'cogs.phrase_tracker']
    for cog in cogs:
        try:
